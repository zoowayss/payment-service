package com.coldlake.app.payment.service.payment.stripe.impl;
        ...
        switch (event.getType()) {
            case CHECKOUT_SESSION_COMPLETED_EVENT: {
                ...
                String orderId = Optional
                        .ofNullable(Optional.ofNullable(session.getMetadata()).orElseThrow(() -> new IllegalArgumentException("metadata is null"))
                                .get("orderId")).orElseThrow(() -> new IllegalArgumentException("orderId is null"));
            ...
            case INVOICE_PAID_EVENT: {
                ...
                if (!StringUtils.hasText(subscriptionId))
                    throw new IllegalArgumentException("subscriptionId is empty");
                ...
                Long paidAt = Optional.ofNullable(invoice.getStatusTransitions())
                        .orElseThrow(() -> new IllegalArgumentException("invoice.statusTransitions is null")).getPaidAt();
