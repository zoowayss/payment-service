...
import com.coldlake.app.payment.domain.payment.paypal.ApplicationContext;
...
import com.coldlake.app.payment.domain.payment.paypal.orders.PaymentCapture;
...
public class PaypalClient {
    ...
    public Subscription createSubscription(Subscription subscription, String host, String successUrlParams, String cancelUrlParams) throws Exception {
        ...
        ApplicationContext applicationContext = new ApplicationContext(paypalProperties.getBrandName(), (StringUtils.hasText(host) ? host : paypalProperties.getReturnUrl()) + successUrlParams, (StringUtils.hasText(host) ? host : paypalProperties.getCancelUrl()) + cancelUrlParams, new ApplicationContext.PaymentMethod(ApplicationContext.PaymentMethod.IMMEDIATE_PAYMENT_REQUIRED));
    ...
    public PayPalOrders orderCreate(PayPalOrders payPalOrders, String host, String returnUrlParams, String cancelUrlParams) throws Exception {
        ...
        payPalOrders.setPaymentSource(new PayPalOrders.PaymentSource(new PayPalOrders.PayPal(new PayPalOrders.ExperienceContext(paypalProperties.getBrandName(), (StringUtils.hasText(host) ? host : paypalProperties.getReturnUrl()) + returnUrlParams, (StringUtils.hasText(host) ? host : paypalProperties.getCancelUrl()) + cancelUrlParams))));
    ...
    public PayPalWebhookValidateResp webhookValidate(Map<String, Object> webhookEvent,
                                                     String authLog,
                                                     String certUrl,
        ...
        try {
            ...
            log.info(cm + " authLog: {} certUrl: {} transmissionId: {} transmissionSig: {} transmissionTime: {} webhookId: {}  webhookEvent:{} ", authLog, certUrl, transmissionId, transmissionSig, transmissionTime, paypalProperties.getWebhookId(), webhookEvent);
